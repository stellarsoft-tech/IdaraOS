...
export default function AssetsFilingPage() {
  ...
  const { data: filesData, isLoading: filesLoading } = useModuleFiles("assets", {
  ...
  return (
    <PageShell 
      title="Asset Files" 
      description="Warranties, invoices, and asset documentation"
      action={
        canCreate && (
    ...
    >
              ...
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  {hasActiveFilters 
                    ...
                    : "Upload asset documentation to get started"
                  }
                </p>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              {file.entityId && (
                                <Link 
                                  href={`/assets/inventory/${file.entityId}`}
      ...
      <Dialog open={showUploadDialog} onOpenChange={setShowUploadDialog}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Upload Asset Files</DialogTitle>
            <DialogDescription>
              Upload warranties, invoices, manuals, etc.
            </DialogDescription>
          </DialogHeader>
          <FileUpload
            moduleScope="assets"
