...
const navigationData: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Access Groups", url: "/people/access-groups", module: "people.access-groups" },
      { title: "Access Register", url: "/people/access-register", module: "people.access-register" },
      { title: "Files", url: "/people/filing", module: "filing.files" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Files", url: "/assets/filing", module: "filing.files" },
  ...
  },
  {
    ...
    icon: FolderArchive,
    items: [
      { title: "Overview", url: "/filing", module: "filing.overview" },
      { title: "All Files", url: "/filing/files", module: "filing.files" },
      { title: "Categories", url: "/filing/categories", module: "filing.categories" },
      { title: "Audit Log", url: "/filing/audit-log", module: "filing.auditlog" },
    ],
  },
  {
    title: "Settings",
