...
export const MODULE_REGISTRY: readonly ModuleRegistryEntry[] = [
  ...
  { slug: MODULES.SECURITY_ACHIEVEMENTS, name: "Achievements", description: "Manage security achievements", category: "Security", icon: "Award", sortOrder: "305.3", actions: [ACTIONS.VIEW, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE] },
  { slug: MODULES.SECURITY_INCIDENTS, name: "Incident Management", description: "Manage information security incidents", category: "Security", icon: "AlertTriangle", sortOrder: "305.5", actions: [ACTIONS.VIEW, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE] },
  { slug: MODULES.SECURITY_NONCONFORMITIES, name: "Nonconformity & Corrective Action", description: "Track nonconformities and corrective actions", category: "Security", icon: "FileWarning", sortOrder: "305.6", actions: [ACTIONS.VIEW, ACTIONS.CREATE, ACTIONS.EDIT, ACTIONS.DELETE] },
