...
const SYSTEM_ROLES: Record<string, {
  ...
  owner: {
    ...
    permissions: {
      ...
      "*": { view: true, write: true, create: true, edit: true, delete: true },
    },
  },
  admin: {
    name: "Admin",
    ...
    permissions: {
      ...
      "people.overview": { view: true, write: true, create: true, edit: true, delete: true },
      "people.directory": { view: true, write: true, create: true, edit: true, delete: true },
      "people.teams": { view: true, write: true, create: true, edit: true, delete: true },
      "people.roles": { view: true, write: true, create: true, edit: true, delete: true },
      "people.workflows": { view: true, write: true, create: true, edit: true, delete: true },
      "people.onboarding": { view: true, write: true, create: true, edit: true, delete: true },
      "people.offboarding": { view: true, write: true, create: true, edit: true, delete: true },
      "people.timeoff": { view: true, write: true, create: true, edit: true, delete: true },
      "people.documents": { view: true, write: true, create: true, edit: true, delete: true },
      "people.auditlog": { view: true, write: false, create: false, edit: false, delete: false },
      // Assets - Full access
      "assets.overview": { view: true, write: true, create: true, edit: true, delete: true },
      "assets.inventory": { view: true, write: true, create: true, edit: true, delete: true },
      "assets.categories": { view: true, write: true, create: true, edit: true, delete: true },
      "assets.assignments": { view: true, write: true, create: true, edit: true, delete: true },
      "assets.maintenance": { view: true, write: true, create: true, edit: true, delete: true },
      "assets.lifecycle": { view: true, write: true, create: true, edit: true, delete: true },
      "assets.settings": { view: true, write: true, create: true, edit: true, delete: true },
      // Security - Full access
      "security.overview": { view: true, write: true, create: true, edit: true, delete: true },
      "security.risks": { view: true, write: true, create: true, edit: true, delete: true },
      "security.controls": { view: true, write: true, create: true, edit: true, delete: true },
      ...
      "workflows.overview": { view: true, write: true, create: true, edit: true, delete: true },
      "workflows.templates": { view: true, write: true, create: true, edit: true, delete: true },
      "workflows.instances": { view: true, write: true, create: true, edit: true, delete: true },
      ...
      "settings.roles": { view: true, write: true, create: true, edit: true, delete: true },
      "settings.integrations": { view: true, write: true, create: true, edit: true, delete: true },
      "settings.auditlog": { view: true, write: false, create: false, edit: false, delete: false },
      "settings.branding": { view: true, write: true, create: true, edit: true, delete: false },
      "settings.apikeys": { view: true, write: true, create: true, edit: true, delete: true },
    },
  },
  manager: {
    name: "Manager",
